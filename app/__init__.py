...
# set up logging
LOG_FILENAME = os.path.join(sys.path[0], app_config[config_name].STATIC_PATH, 'log/ihks-log.txt')
try:
...
def create_admin():
    try:
        ...
        log.info(f'A bit too early, error {e}')
...
from app.presentation.view import auth, user, settings, end_user, reservation, test, survey
